...
base_path = '/Users/prerna/Downloads/Earbud Dataset'
...
def preprocess(path, path_save, version, raw_sr=50, target_sr=20, seq_len=20):
    ...
    for user in users:
        user_path = os.path.join(base_path, user, 'IMU')
    ...
    np.save("/Users/prerna/Downloads/Earbud Dataset/data_20_120.npy", np.array(data))
    np.save("/Users/prerna/Downloads/Earbud Dataset/label_20_120.npy", np.array(labels))
    return data, labels
...
path_save = r'earbud'
version = r'20_120'
DATASET_PATH = r'/Users/prerna/Downloads/Earbud Dataset'
