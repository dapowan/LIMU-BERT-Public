...
base_path = '/Users/prerna/Documents/AccessWear/user_study_2/users/'
...
def preprocess(path, path_save, version, raw_sr=50, target_sr=20, seq_len=20):
    ...
    for user in users:
        user_path = os.path.join(base_path, user, 'gestures')
    ...
    np.save("/Users/prerna/Documents/LIMU-BERT-blind-users/dataset/sighted_user/data_20_120.npy", np.array(data))
    np.save("/Users/prerna/Documents/LIMU-BERT-blind-users/dataset/sighted_user/label_20_120.npy", np.array(labels))
    return data, labels
